...
app.controller("privateChatController",function($scope, ssnocService, $q,$rootScope){
  ...
  $rootScope.socket.on('privatemessage', function(result){
    ...
    if((result.member_id == $rootScope.member.id && result.receiver_id == $rootScope.receiverId)||
  ...
  $scope.sendMessage = function(){
    ...
    console.log($rootScope.member.id);
    ssnocService.addPrivateMessage($scope.chatMessage, $rootScope.currentPosition, $rootScope.member.id, $rootScope.receiverId);
    $scope.chatMessage = "";
  };

  function getPrivateMessages(){
   ssnocService.getPrivateMessage($rootScope.member.id, $rootScope.receiverId)
